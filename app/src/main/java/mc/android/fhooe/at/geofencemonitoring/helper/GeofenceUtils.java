...
public final class GeofenceUtils {
     ...
     */
    public static final String APPTAG = "GeofenceMonitoring";
    ...
    // Transition validity time (Used in GeofenceDatasource)
    public static final int DIFFERENCE_SECONDS = 86400; //86400 seconds = 1 day
    //public static final int DIFFERENCE_SECONDS = 43200; //43200 seconds = 1/2 day
    //public static final int DIFFERENCE_SECONDS = 21600; //21600 seconds = 1/4 day

    // Number of Fences need to be passed befor unlock
    public static final int MIN_NUM_PASSED_FENCES = 3;
