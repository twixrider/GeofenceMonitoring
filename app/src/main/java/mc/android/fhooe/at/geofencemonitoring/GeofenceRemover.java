...
public class GeofenceRemover implements
    ...
    private final String TAG = GeofenceRemover.class.getSimpleName();
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.i(TAG, mContext.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.i(TAG, mContext.getString(R.string.disconnected));
