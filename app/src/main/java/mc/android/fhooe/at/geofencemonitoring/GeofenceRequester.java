...
import mc.android.fhooe.at.geofencemonitoring.service.ReceiveTransitionsIntentService;
...
public class GeofenceRequester
    ...
    private final String TAG = GeofenceRequester.class.getSimpleName();
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.i(TAG, mActivity.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.i(TAG, mActivity.getString(R.string.disconnected));
